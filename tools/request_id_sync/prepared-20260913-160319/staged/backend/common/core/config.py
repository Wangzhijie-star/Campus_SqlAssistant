...
class Settings(BaseSettings):
    ...
    # Dedicated connection for request coordination; unset keeps existing deployments compatible.
    IDEMPOTENCY_REDIS_URL: str | None = None
    IDEMPOTENCY_REDIS_KEY_PREFIX: str = "sqlbot:local"
    IDEMPOTENCY_LOCK_TTL_SECONDS: float = 60
    IDEMPOTENCY_RENEW_INTERVAL_SECONDS: float = 20
    IDEMPOTENCY_TASK_MAX_SECONDS: float = 600
