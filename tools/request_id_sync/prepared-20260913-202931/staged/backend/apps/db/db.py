...
def get_sqlglot_dialect(ds_type: str) -> str:
    ...
    if equals_ignore_case(ds_type, 'postgresql', 'postgres', 'excel'):
        # Imported Excel/CSV tables run on PostgreSQL, including operators such as ~.
        return 'postgres'
    elif equals_ignore_case(ds_type, 'mysql', 'doris', 'starrocks'):
        return 'mysql'
